...
var queryURL = "https://developer.nrel.gov/api/alt-fuel-stations/v1.json?api_key=1YJXSdZ3NnAyyfQjUFBbTnYFAF9lp57gm2pKe94r&fuel_type=ELEC&status=E&access=public&state=CA&limit=10000"
...
function createMarkers(response) {
  ...
  for (var i = 0; i < chargeStations.length; i++) {
    ...
    var chargeMarker = L.marker([charger.latitude, charger.longitude])
      .bindPopup("<h3>" + charger.station_name + "<h3/>");
